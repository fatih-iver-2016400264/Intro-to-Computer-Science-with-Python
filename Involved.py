...
def involved(courses, person):
    ...
    for hexamester in courses:
        ...
        list_inv = []
        dict_classes = courses[hexamester]
        
        for class_ in dict_classes:
            
            dict_property = dict_classes[class_]
            
            for property_ in dict_property:
                    
                if dict_property[property_] == person:
                    
                    list_inv.append(class_)
                    break
        if list_inv:
            dict_inv[hexamester] = list_inv
